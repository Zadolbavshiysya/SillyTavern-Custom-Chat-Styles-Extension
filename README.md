...
Стили для офтрмления текста с помощью тегов. Включает меню настроек цвета и инжект системного промпта. С помощю регулярнвх выражений работают как с []...[/], так и с <>...</> 
